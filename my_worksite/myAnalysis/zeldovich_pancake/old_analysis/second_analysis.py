...
a_init = 0.02
output_dir = "/data/mfulghieri/quokka/outputs/Zeldovich/ZeldovichPancake_11329"
...
for i, plt_file in enumerate(plotfiles):
   ...
   # [('boxlib', 'gasDensity'), ('boxlib', 'gasEnergy'), ('boxlib', 'gasInternalEnergy'), ('boxlib', 'x-GasMomentum'), ('boxlib', 'y-GasMomentum'), ('boxlib', 'z-GasMomentum')]
    ...
    # Volume rendering
    sc = yt.create_scene(ds, ('boxlib', 'gasDensity'))  # set up the scene object
    ...
    source = sc[0] # the source
    source.tfh.set_bounds((3e-31, 5e-27))        # bounds of the tranfert function

    sc.camera.set_position(ds.domain_left_edge)  # move the camera to the left edge of the domain


    sc.save(f"/data/mfulghieri/quokka/my_worksite/myAnalysis/zeldovich_pancake/3D/Density3D_{i:03d}.png", sigma_clip=4.0, render=False)
    print(f"3D analysis completed. Plots saved")
...
plt.savefig("/data/mfulghieri/quokka/my_worksite/myAnalysis/zeldovich_pancake/pancake_physics_stack.png", dpi=300)
