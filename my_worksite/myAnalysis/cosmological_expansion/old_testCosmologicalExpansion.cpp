...
// Since in the new version of test, in /quokka/src/problems/CosmologicalExpansion
// the philosophy of the code was slightly changed, here is a more aligned to the other
// tests backup version
...
template <>
struct quokka::EOS_Traits<ExpansionProblem>
{
...
template <>
struct Physics_Traits<ExpansionProblem>
{
...
template <>
void QuokkaSimulation<ExpansionProblem>::setInitialConditionsOnGrid(quokka::grid const &grid_elem)
{
