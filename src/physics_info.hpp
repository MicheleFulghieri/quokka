...
template <typename problem_t> struct PhysicsTraits {
	...
	static constexpr bool is_hydro_enabled = []() constexpr {
		if constexpr (requires { T::is_hydro_enabled; }) {
			return T::is_hydro_enabled;
		}
		return false;
	}();
	static constexpr int numMassScalars = []() constexpr {
		if constexpr (requires { T::numMassScalars; }) {
			return T::numMassScalars;
		}
		return 0;
	}();
	static constexpr int numPassiveScalars = []() constexpr {
		if constexpr (requires { T::numPassiveScalars; }) {
			return T::numPassiveScalars;
		}
	...
	static constexpr bool is_radiation_enabled = []() constexpr {
		if constexpr (requires { T::is_radiation_enabled; }) {
			return T::is_radiation_enabled;
		}
		return false;
	}();
	static constexpr int nGroups = []() constexpr {
		if constexpr (requires { T::nGroups; }) {
			return T::nGroups;
		}
		return 1;
	}();
	static constexpr bool is_dust_enabled = []() constexpr {
		if constexpr (requires { T::is_dust_enabled; }) {
			return T::is_dust_enabled;
		}
		return false;
	}();
	static constexpr int nDustGroups = []() constexpr {
		if constexpr (requires { T::nDustGroups; }) {
			return T::nDustGroups;
		}
		return 1;
	}();
	...
	static constexpr bool is_self_gravity_enabled = []() constexpr {
		if constexpr (requires { T::is_self_gravity_enabled; }) {
			return T::is_self_gravity_enabled;
		}
		return false;
	}();
	static constexpr bool is_mhd_enabled = []() constexpr {
		if constexpr (requires { T::is_mhd_enabled; }) {
			return T::is_mhd_enabled;
		}
		return false;
	}();
	...
	static constexpr UnitSystem unit_system = []() constexpr {
		if constexpr (requires { T::unit_system; }) {
			return T::unit_system;
		}
	...
	static constexpr bool is_cosmology_enabled = []() constexpr {
		if constexpr (requires { T::is_cosmology_enabled; }) {
			return T::is_cosmology_enabled;
		}
		return false;
	}();
