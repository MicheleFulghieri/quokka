...
a_init = 0.02
output_dir = "/data/mfulghieri/quokka/outputs/ZeldovichPancake_1024_x_resolution"
...
plt.legend()
plt.grid(True)
plt.savefig("/data/mfulghieri/quokka/outputs/ZeldovichPancake_1024_x_resolution/density_profiles1024.png")
plt.close()

print("Analysis complete. Saved plot to /data/mfulghieri/quokka/outputs/ZeldovichPancake_1024_x_resolution/density_profiles1024.png")
