...
plt.legend()
plt.grid(True)
plt.savefig("/data/mfulghieri/quokka/outputs/ZeldovichPancake_512_x_resolution/density_profiles512.png")
plt.close()

print("Analysis complete. Saved plot to /data/mfulghieri/quokka/outputs/ZeldovichPancake_512_x_resolution/density_profiles512.png")
